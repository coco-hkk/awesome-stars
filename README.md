...
- [lintsinghua/claude-code-book](https://github.com/lintsinghua/claude-code-book) - 拆解 AI Agent 的骨架与神经 —— Claude Code 架构深度剖析，15 章从对话循环到构建你自己的 Agent Harness。在线阅读网站：
